<template>
    <ul class="features-list" dir="auto" flex="~ col gap2 md:gap-3">
        ...
        <ListItem>
            <a href="/guide/snapshot"> Jest-compatible Snapshot </a>
        </ListItem>
        <ListItem
            ><a target="_blank" href="https://www.chaijs.com/" rel="noopener noreferrer">Chai</a> built-in for assertions +
            <a target="_blank" href="https://jestjs.io/docs/expect" rel="noopener noreferrer">Jest expect</a> compatible APIs</ListItem
        >
        ...
        <ListItem
            ><a target="_blank" href="https://github.com/capricorn86/happy-dom" rel="noopener noreferrer">happy-dom</a> or
            <a target="_blank" href="https://github.com/jsdom/jsdom" rel="noopener noreferrer">jsdom</a> for DOM mocking</ListItem
        >
